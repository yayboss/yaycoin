    ...
    QWidget(0, f), curAlignment(0)
{
	...
	QString copyrightText3   = QChar(0xA9)+QString(" 2018-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Yaycoin developers"));
	...
	pixPaint.drawText(pixmap.width()-paddingRightCopyright,paddingTop+paddingCopyrightTop+titleCopyrightVSpace+14,copyrightText3);
