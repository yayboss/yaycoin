...
#if defined(NDEBUG)
# error "Yaycoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Yaycoin Signed Message:\n";
...
CAmount GetBlockValue(int nHeight, const CAmount& nFees)
{
    ...
    if(nHeight == 1) return 500000000 * COIN;
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Yaycoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Yaycoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
